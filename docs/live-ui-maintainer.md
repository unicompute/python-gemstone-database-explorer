...
- Add a live test when a bug depends on real GemStone behavior: debugger frame/source behavior, transaction semantics, session/channel isolation, class-browser writes against a real dictionary, Codegen Explorer discovery against live class metadata, or startup/login integration.
